...
func main() {
	// setup email tujuan
	to := []string{"afnangame@gmail.com", "rikzaafnan@gmail.com"}
	// setup cc
	cc := []string{"afnangame@gmail.com"}

	subject := "Test Mail nih"

	// dengan smtpstandart library
	// message := "Hello from admin noobeeid"
	...
	// end dengan smtpstandart library
